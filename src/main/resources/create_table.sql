...
CREATE TABLE BLOG
(
    BLOG_ID          NUMBER(10) AUTO_INCREMENT NOT NULL,
    USER_ID          NUMBER(10),
...
(
    CATEGORY_ID      NUMBER(10) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE POST
(
    POST_ID      NUMBER(10) AUTO_INCREMENT NOT NULL,
...
INSERT INTO BLOG_USER (ID, USER_NAME, ROLE, PASSWORD)
VALUES ('admin', '관리자', 'ADMIN', 'admin123');

INSERT INTO BLOG_USER (ID, USER_NAME, ROLE, PASSWORD)
VALUES ('user', '일반회원', 'USER', 'user123');
